...
function getChilds(element, myclass) {
    var _children, _children2;

    var myclass2 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;

    children = [];
    (_children = children).push.apply(_children, _toConsumableArray(element.getElementsByClassName(myclass)));
    (_children2 = children).push.apply(_children2, _toConsumableArray(element.getElementsByClassName(myclass2)));
    return children;
}
