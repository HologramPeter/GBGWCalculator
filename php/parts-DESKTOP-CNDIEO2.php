<?php
$con = mysqli_connect('localhost','id18556961_hologram','Exia->00Gundam','id18556961_partsdb');
...
$sql="
SELECT PS.id, PS.level, PS.arm, PS.mel, PS.sht, PS.mdf, PS.sdf, PS.bmr, PS.phr,
