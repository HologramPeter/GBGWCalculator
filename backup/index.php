    ...
    <body>
        <div id='titlebar'>
            ...
            <div>
                ...
                <span id='loadingmultiplier' style='color:red;'>Loading Multiplier</span>
            </div>
        ...
        <div>
            <div id="gunpla">
                ...
                <div id="gear-rleg" class="total row">
                    ...
                    <div class='nameContainer'>
                        <select id='gear-rleg-select' onchange="update_gear_rleg(); post_update_gunpla();">
                            <option selected value=''>-選擇-</option>
                            <option value="_#主角機$1 phr#2000 bmr#2000">主角機</option>
                            <option value="_#量產機$1.5 mdf#2000 sdf#2000">量產機</option>
                            <option value="_#王牌專用機$1 phr#2000 bmr#2000">王牌專用機</option>
                            <option value="_#水陸兩用$2 mel#2000 sht#2000">水陸兩用</option>
                            <option value="_#指揮官機$1.5 mdf#2000 sdf#2000">指揮官機</option>
                            <option value="_#近身戰$1 phr#2000 bmr#2000">近身戰</option>
                            <option value="_#中距離戰$2 mel#2000 sht#2000">中距離戰</option>
                            <option value="_#遠距離戰$2 mel#2000 sht#2000">遠距離戰</option>
                            <option value="_#高機動$1.5 mdf#2000 sdf#2000">高機動</option>
                            <option value="_#高火力$1 phr#2000 bmr#2000">高火力</option>
                            <option value="_#重裝甲$2 mel#2000 sht#2000">重裝甲</option>
                            <option value="_#可變$2 mel#2000 sht#2000">可變</option>
                            <option value="_#高達系$1.5 mdf#2000 sdf#2000">鋼彈系</option>
                            <option value="_#MF$1.5 mdf#2000 sdf#2000">MF</option>
                            <option value="_#支援機$2 mel#2000 sht#2000">支援機</option>
                            <option value="_#聯邦$1.5 mdf#2000 sdf#2000">聯邦</option>
                            <option value="_#自護$2 mel#2000 sht#2000">吉翁</option>
                            <option value="_#渣古系$2 mel#2000 sht#2000">薩克系</option>
                            <option value="_#吉姆系$2 mel#2000 sht#2000">吉姆系</option>
                            <option value="_#宇宙適性$2 mdf#2000 sdf#2000">宇宙適性</option>
                            <option value="_#沙漠適性$2 mel#2000 sht#2000">沙漠適性</option>
                            <option value="_#寒帶適性$2 mel#2000 sht#2000">寒帶適性</option>
                            <option value="_#森林適性$2 mel#2000 sht#2000">森林適性</option>
                            <option value="_#市區適性$2 mel#2000 sht#2000">市區適性</option>
                            <option value="_#基地適性$2 mel#2000 sht#2000">基地適性</option>
                            <option value="_#電腦適性$2 mdf#2000 sdf#2000">電腦適性</option>
                        </select>
                    </div>
                </div>
